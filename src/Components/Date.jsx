    ...
    <div className="">
      <Popover placement="bottom">
        ...
        <PopoverContent>
          <DayPicker
            mode="single"
            selected={date ? parseISO(date) : null} // Convert date string to Date object
            ...
            classNames={{
              ...
              cell: "text-blue-600 rounded-md h-9 w-9 text-center text-sm p-0 m-0.5 relative [&:has([aria-selected].day-range-end)]:rounded-r-md [&:has([aria-selected].day-outside)]:bg-gray-900/20 [&:has([aria-selected].day-outside)]:text-white [&:has([aria-selected])]:bg-gray-900/50 first:[&:has([aria-selected])]:rounded-l-md last:[&:has([aria-selected])]:rounded-r-md focus-within:relative focus-within:z-20",
              day: "h-9 w-9 p-0 font-normal",
              day_range_end: "day-range-end",
              day_selected:
                "rounded-md bg-green-900 text-white hover:bg-gray-900 hover:text-white focus:bg-gray-900 focus:text-white",
